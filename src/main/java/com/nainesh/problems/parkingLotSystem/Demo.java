...
import com.nainesh.problems.parkingLotSystem.strategy.fee.VehicleBasedFeeStartegy;
import com.nainesh.problems.parkingLotSystem.vehicle.*;
...
public class Demo {
    public static void main(String[] args) {
        ...
        parkingLot.setFeeStrategy(new VehicleBasedFeeStartegy());
