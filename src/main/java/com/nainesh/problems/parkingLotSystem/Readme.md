...
# We can predefine Parking Slots in respective entity

# Parking Strategy used: SPots are arranged in Concurrent HashMap
- Nearest: for nearest get the nearest flo
- BestFit: get the nearest fit, else return best possible fit, on basis of enum ordinal
- Farthest : get the farthest floor by reverse list

# Rate Calculator: Self Explanatory