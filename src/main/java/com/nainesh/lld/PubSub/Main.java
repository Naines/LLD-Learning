...
import com.nainesh.lld.PubSub.subscriber.AlertSubscriber;
import com.nainesh.lld.PubSub.subscriber.NewsSubscriber;
import com.nainesh.lld.PubSub.subscriber.Subscriber;

public class Main {
    public static void main(String[] args) throws InterruptedException{
        PubSubSystem pubSubService = new PubSubSystem();
