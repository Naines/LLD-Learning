...
import com.nainesh.lld.BookMyShow.Strategy.payment.CreditCardPaymentStrategy;
import com.nainesh.lld.BookMyShow.Strategy.pricing.WeekdayPricingStartegy;
...
import com.nainesh.lld.BookMyShow.observer.UserObserver;
...
public class Main {
    public static void main (String[]args){
        ...
        // Add Shows
        Show matrixShow = service.addShow("show1", matrix, screen1, LocalDateTime.now().plusHours(2), new WeekdayPricingStartegy());
        Show avengersShow = service.addShow("show2", avengers, screen1, LocalDateTime.now().plusHours(5), new WeekdayPricingStartegy());
