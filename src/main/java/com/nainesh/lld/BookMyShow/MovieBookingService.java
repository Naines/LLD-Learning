...
public class MovieBookingService {
    ...
    public Show addShow(String id, Movie movie, Screen screen, LocalDateTime startTime, PricingStartegy pricingStartegy) {
        Show show = new Show(id, movie, screen, startTime, pricingStartegy  );
